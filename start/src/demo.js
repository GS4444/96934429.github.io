{
    {
        ...
        function get_suggest() {
            ...
            script.src = 'https://duckduckgo.foursearch.cf/?q=' + encodeURIComponent(kw) + '&_=' + new Date().getTime() + '&callback=jsonp3';
        ...
        function search() {
            if (document.getElementById("search_input").value != "") {
                window.location.href = "https://duckduckgo.foursearch.cf/?q=" + encodeURIComponent(document.getElementById("search_input").value) + "&uc_param_str=dnntnwvepffrgibijbprsvdsme&from=ucframe&uc_sm=1";
